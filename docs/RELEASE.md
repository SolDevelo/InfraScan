...
### Build and Push
Replace `<version>` with the new version (e.g., `v1.0.9`).
```bash
# Build
...
git tag -fa v1 -m "Update v1 to v1.0.9"
...
3. Select the tag you just pushed (e.g., `v1.0.9`).
4. Set the Release Title (e.g., `InfraScan v1.0.9`).
